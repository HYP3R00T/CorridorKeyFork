"""Property-based tests for corridorkey.stages.preprocessor.resize."""
...
class TestResizeFrameProperties:
    ...
    def test_alpha_always_clamped(self, h: int, w: int, img_size: int):
        ...
        _, alpha_out = resize_frame(_make_image(h, w), alpha, img_size)
    ...
    def test_already_square_same_size_unchanged_shape(self, img_size: int):
        ...
        img_out, alpha_out = resize_frame(_make_image(img_size, img_size), _make_alpha(img_size, img_size), img_size)
